...
//console.log('element on top of ', idx);        
     ...
     //   console.log('event is ',event);
       ...
       //   console.log('this get me item data ',data);
        } catch(e) {
        ...
        //console.log('tell if to copy or create',dndState.dropEffect );
        if (!ignoreDataTransfer) {
          event.dataTransfer.dropEffect = dropEffect;
        }

        // Insert the object into the array, unless dnd-drop took care of that (returned true).
   //     console.log('object at this stage ',data);
        if (data !== true) {
        	//console.log('run a render html');
        	
          scope.$apply(function() {
          	//attr.$$element[0].style.color =""
          	//console.log('shhit',attr.$$element[0].style);
          	
         // console.log('att list    -', attr.dndList, ' - index of something   -', index  , 'data of wgat   ', data);
          //  console.log(attr);
            scope.$eval(attr.dndList).splice(index, 0, data);
          //  console.warn('ubde abd data', index, data)
           
          });
          
         //   console.log('here is the fucker children', attr.$$element[0].children);
        //    console.log('here is the fucker children type of', typeof attr.$$element[0].children);
        //           console.log('here is the fucker children type lenght', attr.$$element[0].children.length);
        //     console.log('here is the fucker', attr.$$element[0].children[index].length);
          ...
          if(data.type == 'item'){
           	 ...
           	 if(index >= 1){
           //	console.log('location of child lef',  attr.$$element[0].children[0].offsetLeft);
            var placeholderin =  getPlaceholderIndex();
            var objBeforePlaceholder = getPlaceholderIndex() - 2;
          //  console.log('placeholder index', placeholderin,  objBeforePlaceholder );
           
           	 var obPosLeft = attr.$$element[0].children[objBeforePlaceholder].offsetLeft,
              	 obPosWidth = attr.$$element[0].children[objBeforePlaceholder].offsetWidth,
           	     obtotal = parseInt(obPosLeft) + parseInt(obPosWidth),
           	     setLeft = event.clientX - obtotal;
           	 	 
           	 	// console.log(event.clientX , obtotal , setLeft );
           	 	  attr.$$element[0].children[index].style.marginLeft= setLeft + 'px';
           	 	
           	 	
           	 		 //console.log('child lef',  obPosLeft );
           // console.log('location of child lef',  obtotal );
		...
		//console.log(attr.dndInserted, event, dropEffect, itemType, index, data);
